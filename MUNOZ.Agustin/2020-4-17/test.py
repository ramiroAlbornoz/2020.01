import unittest
from alumno1 import Persona, Alumno
from parameterized import parameterized

class TestAlumno(unittest.TestCase):
    @parameterized.expand([(1, "Fernandez", "Cristina", "1: Fernandez, Cristina"), (2, "Fernandez", "Alberto", "2: Fernandez, Alberto"), (5, "Guzman", "Martín", "5: Guzman, Martín")])
