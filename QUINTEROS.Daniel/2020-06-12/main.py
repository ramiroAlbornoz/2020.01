...
while not hecho:
    ...
    # Usando un bucle for, dibujamos sobre la pantalla varias líneas rojas de
    # 5 píxeles de ancho, que vayan desde (0,10) hasta (100,110).
    for desplazar_y in range(0, 100, 10):
        pygame.draw.line(pantalla, ROJO, [0, 10 + desplazar_y],
                         [100, 110 + desplazar_y], 5)

    # Dibujamos un rectángulo
    pygame.draw.rect(pantalla, NEGRO, [20, 20, 250, 100], 2)

    # Dibujamos una elipse, usando un rectángulo para fijar sus bordes
    # exteriores
    ...
    # El color es negro. Esto nos crea una imagen de las letras,
    #  pero no las coloca sobre la pantalla.
