...
class Pelicula():
    ...
    def __str__(self):
        return "{} {} ({}) {}".format(self.codigo, self.titulo, self.lanzamiento, self.genero)
...
class PeliculaRepo():
    ...
    def update(self):
        print("update: ")
        u = input("ingrese el codigo de pelicula que desea cambiar: ")
        if u > len(self.catalogo):
    ...
    def borrar(self):
        print("delete: ")
        u = input("ingrese el codigo de pelicula que desea borrar: ")
        if u > len(self.catalogo):
            print("esa pelicula no existe")
        else:
            peli = Pelicula
    ...
    def mostrar_por_numero(self):
        ...
        u = input("ingrese el codigo de pelicula que desea mostrar: ")
        if u > len(self.catalogo):
            print("esa pelicula no existe")
        else:
